...
class Cart extends Model
{
    ...
    public function getFromSessionID()
    {
        ...
        $rs = $sql->select("SELECT * FROM tb_carts WHERE dessessionid= :dessessionid", [
            ':dessessionid'=>session_id()
        ]);
    ...
    public function get(int $idcart)
    {
        ...
        $rs = $sql->select("SELECT * FROM tb_carts WHERE idcart= :idcart", [
            ':idcart'=>$idcart
        ]);
    ...
    public function getProductsTotals()
    {
        ...
        $rs = $sql->select("SELECT SUM(vlprice) AS vlprice, SUM(vlwidth) AS vlwidth, SUM(vlheight) AS vlheight, 
    ...
    public function setFreight($nrzipcode)
    {
        ...
        if($totals['nrqtd'] > 0){
            ...
            $rs = $xml->Servicos->cServico;

            if($rs->MsgErro != ''){
                Cart::setMsgError($rs->MsgErro);

            }else{
                Cart::clearMsgError();
            }

            $this->setnrdays($rs->PrazoEntrega);
            $this->setvlfreight(Cart::formatValueToDecimal($rs->Valor));
